...
public class Util {
    ...
    public static String rollSaveFilename(String savePath, String fileName) {
        int i = 0;
        while (new File(savePath + fileName + i + ".kchess").exists()) {
            i++;
        }

        return savePath + fileName + i + ".kchess";
    }
